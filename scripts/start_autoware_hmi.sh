...
Purpose:
  Start Autoware autoware.launch.xml together with the single-window HMI.
...
Environment overrides:
  ...
  APS_HMI_FULLSCREEN              true/false, forwarded to autoware.launch.xml (default: true)
...
exec ros2 launch autoware_launch autoware.launch.xml${AUTOWARE_ARG_STRING}"
