...
Environment overrides:
  ...
  APS_AUTOWARE_SENSOR_CONFIG_PROFILE sensor_config_profile override (default: aps007)
...
AUTOWARE_SENSOR_CONFIG_PROFILE="${APS_AUTOWARE_SENSOR_CONFIG_PROFILE:-aps007}"
